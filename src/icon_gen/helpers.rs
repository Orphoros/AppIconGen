...
pub fn generate_images(input_img: &DynamicImage) -> HashMap<IconType, DynamicImage> {
...
pub fn dump_images(icns_images: &HashMap<IconType, DynamicImage>, out: &str) {
    for (icon_type, img) in icns_images.iter() {
        ...
        let path = format!("{}_{}.png", out, type_name);
